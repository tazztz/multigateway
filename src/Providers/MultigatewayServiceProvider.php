...
namespace Turtlecap\Multigateway\Providers;
...
class MultigatewayServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
         $this->publishes([
             __DIR__.'/../../config/multigateway.php' => config_path('multigateway.php'),
         ], 'multigateway-config');
         ...
         */
         $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'multigateway');
         $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'multigateway');
         $this->publishes([
             __DIR__.'/../../resources/lang' => resource_path('lang/vendor/multigateway'),
         ], 'translations');
         ...
         */
         $this->loadViewsFrom(__DIR__.'/../../resources/views', 'multigateway');
         $this->publishes([
             __DIR__.'/../../resources/views' => resource_path('views/vendor/multigateway'),
         ], 'views');
        ...
        //     $this->commands([
        //         \Turtlecap\Multigateway\Console\Commands\MultigatewayCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/multigateway'),
        // ], 'public');
    ...
    public function register()
    {
         ...
         */
         $this->mergeConfigFrom(
             __DIR__.'/../../config/multigateway.php', 'multigateway'
         );
         ...
         *
         * */
        app()->bind('TzMultiGateway',function (){
            return new MultiGatewayHelpers();
        });
