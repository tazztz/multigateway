...
class MidtransPay extends MultiGatewayBase
{
    /*
* charge_amount();
* @required param list
...
* */
    ...
    private function setConfig(array $args = [])
    {
        ...
        \Midtrans\Config::$serverKey = config('multigateway.midtrans.server_key');
// Set to Development/Sandbox Environment (default). Set to true for Production Environment (accept real transaction).
        \Midtrans\Config::$isProduction = config('multigateway.midtrans.envaironment');
