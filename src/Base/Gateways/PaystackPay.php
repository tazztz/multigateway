...
class PaystackPay extends MultiGatewayBase
{
    ...
    public function charge_customer(array $args)
    {
        ...
        $paystack_data['route'] = route('tz.payment.gateway.paystack');
        $paystack_data['type'] = $args['payment_type'] ?? 'random';

        return view('multigateway::paystack')->with(['paystack_data' => $paystack_data]);
    }
    ...
    public function setConfig(){
        config([
            'paystack.merchantEmail' => config('multigateway.paystack.merchant_email'),
            'paystack.secretKey' => config('multigateway.paystack.secret_key'),
            'paystack.publicKey' => config('multigateway.paystack.public_key'),
            'paystack.paymentUrl' =>config('multigateway.paystack.payment_url'),
        ]);
    }
}
