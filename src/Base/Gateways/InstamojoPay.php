...
class InstamojoPay extends MultiGatewayBase
{
...
//                'webhook' => '', //webhook option will be avilable in future
    ...
    {
        $prefix = config('multigateway.instamojo.test_mode') ? 'test' : 'api';
    ...
    protected function setConfig()
    {
        ...
        $response = Http::asForm()
            ->withBasicAuth(config('multigateway.instamojo.client_id'), config('multigateway.instamojo.client_secret'))
