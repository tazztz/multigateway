...
class CashFreePay extends MultiGatewayBase
{
    ...
    {
        $secretKey = config('multigateway.cashfree.secret_key');
    ...
    public function charge_customer(array $args)
    {
        ...
        return view('multigateway::cashfree',['payment_data' => $data]);
    }
    ...
    {
        return [
          'app_id' => config('multigateway.cashfree.app_id'),
          'secret_key' => config('multigateway.cashfree.secret_key'),
          'order_currency' => 'INR',
    ...
    public function get_api_url(){
        return config('multigateway.cashfree.test_mode') ?
