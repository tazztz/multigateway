...
class StripePay extends MultiGatewayBase
{
   ...
   /**
    ...
    public function ipn_response(array $args = []) : array
    {
        ...
        $stripe = new StripeClient(config('multigateway.stripe.secret_key'));
    ...
    public function stripe_view($args){
        return view('multigateway::stripe', ['stripe_data' => $args]);
    }

    public function charge_customer_from_controller(array $args){
        Stripe::setApiKey(config('multigateway.stripe.secret_key'));
